...
<div class="row d-flex justify-content-start my-2">
    <div class="dropdown row d-flex justify-content-start my-2">
        ...
        <div class="dropdown" style="width: fit-content;">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('vote', ['level' => 1]) }}">1</a></li>
                <li><a class="dropdown-item" href="{{ route('vote', ['level' => 2]) }}">2</a></li>
                <li><a class="dropdown-item" href="{{ route('vote', ['level' => 3]) }}">3</a></li>
                <li><a class="dropdown-item" href="{{ route('vote', ['level' => 4]) }}">4</a></li>
                <li><a class="dropdown-item" href="{{ route('vote', ['level' => 5]) }}">5</a></li>
                <li><a class="dropdown-item" href="{{ route('vote', ['level' => 6]) }}">6</a></li>
                <li><a class="dropdown-item" href="{{ route('vote', ['level' => 7]) }}">7</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="card-body p-3">
                <div class="row">
                    ...
                    <a class="nav-link" href="/add/candidat">
                        <div class="d-flex justify-content-start mt-4 container-fluid">
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    ...
                    <div class="d-flex justify-content-start mt-4 container-fluid">
                        <a href="{{ route('vote', ['level' => 1]) }}" class="btn btn-primary w-100 my-0">Voter</a>
                    </div>
                </div>
            </div>
        </div>
